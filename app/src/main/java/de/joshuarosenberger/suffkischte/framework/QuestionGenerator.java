...
public class QuestionGenerator {
    ...
    private void generateGeneralRules(int duplicates){
        for (int i = 0; i <= duplicates; i++) {
            ...
            questions.add(new Question("Wasserfall! " + Question.ACTIVE_PLACEHOLDER + " beginnt aber " + Question.PASSIVE_PLACEHOLDER + " darf sich die Richtung aussuchen!"));
            questions.add(new Question(Question.ACTIVE_PLACEHOLDER + "muss eine Runde um den Tisch laufen"));
            questions.add(new Question(Question.PASSIVE_PLACEHOLDER + " und " + Question.PASSIVE_PLACEHOLDER + " müssen Oberteile tauschen!"));
            questions.add(new Question("Derjenige der zuletzt den Dauemen auf dem Tisch liegen hat muss 2 Schlücke trinken!"));
